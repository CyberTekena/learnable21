...
A React interface concept for discovering emergency-service information, paramedics, and related resources. This repository is the `learnable21` version in a family of related frontend iterations.
...
```sh
git clone https://github.com/CyberTekena/learnable21.git
cd learnable21
npm install
npm run dev
```
